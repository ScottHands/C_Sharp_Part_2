...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Image ID="Image1" runat="server" Height="150px" ImageUrl="random" Width="150px" />
            <asp:Image ID="Image2" runat="server" Height="150px" ImageUrl="Random" Width="150px" />
            <asp:Image ID="Image3" runat="server" Height="150px" ImageUrl="Random" Width="150px" />
            <br />
            <br />
            Your Bet:
